    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Welcome <?php echo $patient->username; ?></div>
                ...
                <div class="panel-body">
                    ...
                    <!-- Custom checkboxes -->
                    <input type="checkbox" name="save" value="Bike">Save all my details when conducting a questionnaire.<br>
                    <input type="checkbox" name="nosave" value="Car">Don't save any of my data when creating a questionnaire.<br>
